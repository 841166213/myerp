...
$(function(){
    ...
    $("#dataGrid").jqGrid({
        ...
        autowidth:true,
        shrinkToFit: false,
        caption: "${data.DWMC} ${data.SBND}年度 差额申报",
        colModel:[
             {label:'操作', name:'opt',index:'opt', formatter:formatOpt, sortable:false, align:'center', width:'300px'},
            {label:'审核状态', name:'SHZT_SBXX',index:'SHZT_SBXX', sortable:false, align:'center', formatter:'select', formatoptions:{value:STD.shzt}},
            ...
            {label:'房改面积', name:'FGMJ',index:'FGMJ', sortable:false, align:'center', width:'200px'},
	...
	function doHistoryCheck(ids){
		var title = "申报信息校验";
		var url = "fgb/sbxxCheck?sblx=2&ids="+ids.join(",");
