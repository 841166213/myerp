...
<style>
	...
	.jzqkTable tr{ text-align:center; height: 33px;}
	.jzqkTable td{border:1px solid #848484;}
	.textColumn{ font-size:14px; color:#808080; text-align: -webkit-right; padding: 8px;}
	span{
		padding-right: 30px;
		font-size:16px;
	}
...
function doVerify(ID){
	var SHYJ_CZJ = $("#SHYJ_CZJ").val();
	parent.layer.confirm("是否审核通过？",function(index){
		myAjax({ url: "czj/czjPass", 
			data: {ID: ID, SHYJ_CZJ: SHYJ_CZJ},
...
<table>
<tr>
	<td width="10%" class="textColumn">审核信息<br></td>
	<td width="90%" >
		<div align="center">
			<table width="788" border="1" class="jzqkTable">
			  <tr>
			    <td height="79" colspan="2" rowspan="2" align="left" scope="col" style="background-image:url('images/tableLine1.png'); background-repeat:no-repeat;"><p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发补贴情况<br />
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 类别</p></td>
			...
			<table width="788" border="1" class="jzqkTable">
			  <tr>
			    ...
			    <td height="79" width="220" rowspan="2" align="left" scope="col" style="background-image:url('images/tableLine2.png'); background-repeat:no-repeat;"><p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其中<br />
			    &nbsp;&nbsp;人员情况合计</p></td>
			...
			职称</td>
			  ...
			  <tr>
			    <td colspan="9" align="left">&nbsp;&nbsp;<span>注：1、①=②+③+⑥+⑨</span><span>2、③=④+⑤</span>3、⑥=⑦+⑧</td>
			  </tr>
			</table>
		</div>
	</td>
...
<tr>
	<td width="10%" class="textColumn">审核意见</td>
	<td width="90%" ><textarea id="SHYJ_CZJ" rows="3" cols="70" name="SHYJ_CZJ">${data.SHYJ_CZJ }</textarea></td>
</tr>
</table>
