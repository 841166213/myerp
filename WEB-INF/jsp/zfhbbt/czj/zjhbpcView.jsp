		...
		<div class="whiteBox actionArea">
			<div class="flexigrid">
				...
				<input type="hidden" name="ID" value="${data.ID}">
					<span>批次：</span>
					<span class="inputBox"><input name="PC" type="text" class="inputText" data-rule="required" value="${data.PC}" readonly></span>
					<span>划拨日期：</span>
					<span class="inputBox"><input name="HBRQ" type="text" class="inputText" value="${data.HBRQ}" readonly></span>
					<span>划拨金额：</span>
