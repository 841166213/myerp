...
$(function(){
    ...
    $("#dataGrid").jqGrid({
        url: "sb/dwsbHistoryPage",
        datatype:"json",
        mtype:"POST",
        postData: {SBDW: dwid},
        height:'auto',
        autowidth:true,
        caption: STD.jgdw[dwid]+" 申报历史",
        colModel:[
			{label:'操作', name:'opt',index:'opt', formatter:formatOpt, sortable:false, align:'center', width:'300px'},
            ...
            {label:'编委办审核状态', name:'SHZT_BWB',index:'SHZT_BWB', sortable:false, align:'center', formatter:'select', formatoptions:{value:STD.shzt}},
            {label:'房改办审核状态', name:'SHZT_FGB',index:'SHZT_FGB', sortable:false, align:'center', formatter:'select', formatoptions:{value:STD.shzt}}
        ],
        rownumbers:true,
        viewrecords: true,
        rowNum:10,
    ...
    function formatOpt(value, colObjet, colValue){
    	var a1 = "<a class='gridOper' href=\"javascript:dwqeSbView("+colValue.ID+",1)\" ><img src=\"images/grid_view.png\">全额申报查看</a> "; 
        var a2 = "<a class='gridOper' href=\"javascript:dwceSbView("+colValue.ID+",1)\"><img src=\"images/grid_view.png\">差额申报查看</a> ";
        var a3 = "<a class='gridOper' href=\"javascript:dwsbqkbView("+colValue.ID+")\" ><img src=\"images/grid_view.png\">申报情况查看</a> "
        return a1+a2+a3;
	}
