...
<table width="1300" style="margin:7px 15px;">
  <tr>
    <td colspan="10" align="center" class="bigSize">发放差额货币补贴职工情况明细表</td>
  </tr>
  <tr class="smallSize">
    <td width="6%">&nbsp;填报单位：</td>
...
发放标准</td>
  ...
  <tr>
    <td colspan="10" class="smallSize" align="left">&nbsp;填表说明：一、“居住情况”指下列情况：①租用单位住房；②租用房管直管公房；③租用其他住房（含租用私房和其它出租屋，及寄居亲朋的房屋）；④已购买商品住房；⑤自有私房；⑥购买房改房。<br />
     <span>二、首年申领人员，有行政职务的提供任职文件复印件，有技术职务的提供资格证和聘书复印件。</span><br />
