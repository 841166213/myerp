...
$(function(){
    ...
    $("#dataGrid").jqGrid({
        ...
        colModel:[
            ...
            {label:'进入单位工作时间', name:'JRJGSYDWGZSJ',index:'JRJGSYDWGZSJ', sortable:false, align:'center', width:'200px'},
            ...
            {label:'现居住房屋地址', name:'XJZFWDZ',index:'XJZFWDZ', sortable:false, align:'center', width:'300px'},
	...
	$("#add_btn").click(function() {
		openDialog_L('sb/rysbxxEdit?dwsbId='+dwsbId+"&sblx=1&sbnd="+sbnd, '新增全额申报')
	});
	...
	function editItem(id){
		openDialog_L("sb/rysbxxEdit?id="+id+"&sblx=1&sbnd="+sbnd, '修改全额申报信息');
	}
...
<body>
    ...
    <div id="importForm" style="display: none">
		<form id="validForm" action="sb/importDwqesb" method="post">
			...
			<table class="formTable">
				...
				<tr>
					...
					<td valign="top"><a href="sb/downloadDwqesbImportModel">下载导入模板</a></td>
				</tr>
			</table>
		</form>
